...
exports.getValidator = exports.getRegistryPort = exports.getRegistry = exports.getDatabase = exports.getAccounts = exports.LocalTableland = void 0;
...
Object.defineProperty(exports, "getDatabase", { enumerable: true, get: function () { return util_js_1.getDatabase; } });
Object.defineProperty(exports, "getRegistry", { enumerable: true, get: function () { return util_js_1.getRegistry; } });
Object.defineProperty(exports, "getRegistryPort", { enumerable: true, get: function () { return util_js_1.getRegistryPort; } });
Object.defineProperty(exports, "getValidator", { enumerable: true, get: function () { return util_js_1.getValidator; } });
...
class LocalTableland {
    ...
    async start() {
        const configFile = await (0, util_js_1.getConfigFile)();
        const config = (0, util_js_1.buildConfig)({ ...configFile, ...this.config });
        ...
        if (typeof config.registryDir === "string" &&
            ...
            this.registryDir = (0, util_js_1.defaultRegistryDir)();
        }
        ...
        if (typeof config.registryPort === "number") {
            ...
            if (!(0, util_js_1.isValidPort)(config.registryPort))
    ...
    _deployRegistry() {
        ...
        (0, util_js_1.logSync)(spawnSync((0, util_js_1.isWindows)() ? "npx.cmd" : "npx", ["hardhat", "run", "--network", "localhost", "scripts/deploy.ts"], {
            cwd: this.registryDir,
        }), !(0, util_js_1.inDebugMode)());
    }
...
_LocalTableland__readyResolves = new WeakMap(), _LocalTableland_instances = new WeakSet(), _LocalTableland__start = async function _LocalTableland__start(config = {}) {
    ...
    const registryPortIsTaken = await (0, util_js_1.checkPortInUse)(this.registryPort);
    ...
    if (this.registryPort !== this.defaultRegistryPort &&
        this.silent !== true) {
        shelljs_1.default.echo(`[${chalk_js_1.chalk.magenta.bold("Notice")}] Registry is using custom port ${this.registryPort}`);
    }
    ...
    this.registry = (0, cross_spawn_1.default)((0, util_js_1.isWindows)() ? "npx.cmd" : "npx", ["hardhat", "node", "--port", this.registryPort.toString()], // Use a custom hardhat port
    {
    ...
    const provider = (0, ethers_1.getDefaultProvider)(`http://127.0.0.1:${this.registryPort}`);
    ...
    const ValidatorClass = this.docker
        ? validators_js_1.ValidatorDev
        : validators_js_1.ValidatorPkg;
    ...
    // this process should keep running until we kill it
    (0, util_js_1.pipeNamedSubprocess)(chalk_js_1.chalk.yellow.bold("Validator"), this.validator.process, {
        // use events to indicate when the underlying process is finished
        // initializing and is ready to participate in the Tableland network
