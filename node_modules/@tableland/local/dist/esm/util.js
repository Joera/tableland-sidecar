 ...
 */
export const isValidPort = function (port) {
    return Number.isInteger(port) && port >= 1 && port <= 65535;
};
export const logSync = function (prcss, shouldThrow = true) {
...
export const waitForReady = async function (readyEvent, emitter) {
 ...
 */
export const getDatabase = function (account) {
    return new Database({
        signer: account,
 ...
 * signer.
 */
export const getRegistry = function (account) {
    return new Registry({
        signer: account,
    });
};
 ...
 */
export const getValidator = function (baseUrl) {
 ...
 * @returns An instance of a Tableland `Validator` with the correct `baseUrl`.
 */
export const getAccounts = function (instance) {
 ...
 */
export const getRegistryPort = (instance) => {
