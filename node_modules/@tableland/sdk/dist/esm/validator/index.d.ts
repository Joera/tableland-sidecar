import { type Signal, type PollingController, type ReadConfig, type ChainName } from "../helpers/index.js";
...
export declare class Validator {
     ...
     */
    health(signal?: Signal): Promise<boolean>;
    /**
     * Get version information
     * @description Returns version information about the validator daemon
     */
    version(signal?: Signal): Promise<Version>;
    /**
     * Get table information
     * @description Returns information about a single table, including schema information
     */
    getTableById(params: TableParams, signal?: Signal): Promise<Table>;
    /**
     * Query the network
     * @description Returns the results of a SQL read query against the Tabeland network
     */
    queryByStatement<T = unknown>(params: QueryParams<"objects" | undefined>, signal?: Signal): Promise<ObjectsFormat<T>>;
    queryByStatement<T = unknown>(params: QueryParams<"table">, signal?: Signal): Promise<TableFormat<T>>;
    /**
     * Get transaction status
     * @description Returns the status of a given transaction receipt by hash
     */
    receiptByTransactionHash(params: ReceiptParams, signal?: Signal): Promise<TransactionReceipt>;
    /**
     * Wait for transaction status
     * @description Polls for the status of a given transaction receipt by hash until
     */
    pollForReceiptByTransactionHash(params: ReceiptParams, controller?: PollingController): Promise<TransactionReceipt>;
}
