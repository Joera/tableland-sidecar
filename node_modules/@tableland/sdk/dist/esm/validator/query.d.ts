...
export declare function getQuery<T = unknown>(config: FetchConfig, params: Params<"objects" | undefined>, signal?: Signal): Promise<ObjectsFormat<T>>;
export declare function getQuery<T = unknown>(config: FetchConfig, params: Params<"table">, signal?: Signal): Promise<TableFormat<T>>;
