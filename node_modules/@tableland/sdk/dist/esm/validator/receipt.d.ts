...
import { type PollingController, type Signal } from "../helpers/await.js";
...
export declare function getTransactionReceipt(config: FetchConfig, params: Params, signal?: Signal): Promise<TransactionReceipt>;
export declare function pollTransactionReceipt(config: FetchConfig, params: Params, controller?: PollingController): Promise<TransactionReceipt>;
export {};
