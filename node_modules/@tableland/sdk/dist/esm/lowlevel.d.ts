...
export declare function queryRaw<T = unknown>(config: ReadConfig, statement: string, signal?: Signal): Promise<Array<ValueOf<T>>>;
export declare function queryAll<T = unknown>(config: ReadConfig, statement: string, signal?: Signal): Promise<ObjectsFormat<T>>;
export declare function queryFirst<T = unknown>(config: ReadConfig, statement: string, signal?: Signal): Promise<T | null>;
