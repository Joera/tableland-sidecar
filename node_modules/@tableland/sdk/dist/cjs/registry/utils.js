...
exports.wrapManyTransaction = exports.wrapTransaction = exports.extractReadonly = exports.wrapExecResult = exports.wrapResult = void 0;
 ...
 */
function wrapExecResult(result, count) {
...
exports.wrapExecResult = wrapExecResult;
...
async function wrapTransaction(conn, prefix, tx) {
    ...
    const wait = async (controller) => {
        const receipt = await (0, receipt_js_1.pollTransactionReceipt)(conn, params, controller);
