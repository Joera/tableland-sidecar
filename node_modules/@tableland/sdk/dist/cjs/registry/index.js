...
class Registry {
     ...
     */
    async listTables(owner) {
        return await (0, tables_js_1.listTables)(this.config, owner);
    }
    /**
    ...
    async safeTransferFrom(params) {
        return await (0, transfer_js_1.safeTransferFrom)(this.config, params);
    }
    /**
     ...
     */
    async setController(params) {
        return await (0, controller_js_1.setController)(this.config, params);
    }
    /**
     ...
     * - `tableId` controller must not be locked
     */
    async lockController(table) {
        return await (0, controller_js_1.lockController)(this.config, table);
    }
    /**
     ...
     * tableId - the id of the target table
     */
    async getController(table) {
        return await (0, controller_js_1.getController)(this.config, table);
    }
    /**
     ...
     */
    async create(params) {
        return await (0, create_js_1.create)(this.config, params);
    }
    /**
     ...
     */
    async mutate(params) {
        return await (0, run_js_1.mutate)(this.config, params);
    }
}
