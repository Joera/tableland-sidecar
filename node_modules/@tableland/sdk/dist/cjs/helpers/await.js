...
exports.isPollingController = exports.getAsyncPoller = exports.createPollingController = exports.createSignal = void 0;
/**
 ...
 */
function createPollingController(timeout = 60000, pollingInterval = 1500) {
    const controller = new AbortController();
...
exports.createPollingController = createPollingController;
/**
 ...
 */
async function getAsyncPoller(fn, controller) {
 ...
 */
function isPollingController(arg) {
    return (arg != null &&
...
exports.isPollingController = isPollingController;
