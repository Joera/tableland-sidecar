...
class Validator {
     ...
     */
    async health(signal) {
        return await (0, health_js_1.getHealth)(this.config, signal);
    }
    /**
    ...
    async version(signal) {
        return await (0, version_js_1.getVersion)(this.config, signal);
    }
    /**
     * Get table information
     * @description Returns information about a single table, including schema information
     */
    async getTableById(params, signal) {
    ...
    async queryByStatement(params, signal) {
        return await (0, query_js_1.getQuery)(this.config, params, signal);
    }
    /**
     * Get transaction status
     * @description Returns the status of a given transaction receipt by hash
     */
    async receiptByTransactionHash(params, signal) {
        return await (0, receipt_js_1.getTransactionReceipt)(this.config, params, signal);
    }
    /**
     * Wait for transaction status
     * @description Polls for the status of a given transaction receipt by hash until
     */
    async pollForReceiptByTransactionHash(params, controller) {
        return await (0, receipt_js_1.pollTransactionReceipt)(this.config, params, controller);
    }
}
